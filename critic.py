...
def train(loader, model_critic):
    ...
    accelerator = Accelerator(gradient_accumulation_steps=16,  mixed_precision='fp16')
...
def main():
    ...
    model_critic = load_model(tokenizer)
    train(loader, model_critic)
